...
class _HomePageState extends State<HomePage> {
  ...
  _init() async {
    ...
    const newProduct2 = Product(
      ...
      price: 4.99,
      description: '¡El perro caliente definitivo! Con todos los ingredientes que amas: salchicha de alta calidad, pan recién horneado, cebolla caramelizada, jalapeños picantes, queso derretido y una deliciosa salsa especial.',
      url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdMUMtR0GavWYtId0SRbOi7ALClfYolyzSJw&s',
    );
